...
$(function () {
    ...
    $('.countdown').downCount({
        date: '06/02/2020 09:00:00', // Change this time mm/dd/yyyy date
        offset: +10
    }, function () {
    ...
    var coord1 = '-6.240839'; // Coordinat - 1
    var coord2 = '106.582286'; // Coordinat - 2
    var popupaddress = 'Binong 1 Resedence'; // Address
    var mapzoom = "14"; // Map Zoom
    ...
    L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
        maxZoom: 18,
        id: 'mapbox.streets',
        accessToken: 'pk.eyJ1IjoibmVjcm9uYXVnaHQiLCJhIjoiY2thMG0yczd6MHEwbTNmbnYwcnA5NmtubSJ9.5wUXAwKlN0i742j1D5mEpw', /* Change this api with yours. */
        zoomControl: false,
    }).addTo(mymap);
    var markerIcon = L.icon({
        iconUrl: 'http://kavio_such_ci.test/inti/dist/img/marker.png',
